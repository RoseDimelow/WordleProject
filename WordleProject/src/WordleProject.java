...
public class WordleProject 
{
	...
	public static void greetUser()
	{
		...
		else if (userChoice.equals("B") || userChoice.equals("b"))
		{
			...
			System.out.println("Letters from the word that you use as your guess can either be...");
			System.out.println("... in the right place (♥)");
			System.out.println("... the right letter in the wrong place (*)");
			System.out.println("... or completely wrong (X)");
